...
<head>
    ...
    <script type="text/javascript">
        function update(){
            document.forms[0].action = "updateCompany.htm";
        ...
        <div class="wrap">
            <fieldset style="text-align:right;">
                ...
                <table style="margin:auto;top:50%;left:50%;">
                    <tr>
                        <td>
                            <label for="companyDetails" style="font-size: .70em;">
                                CompanyDetails
                            </label>
                        </td>
                        <td colspan="2">&nbsp;</td>
                        <td>
                            <form:textarea path="currentCompanyTermsVO.companyDetails" rows="5" cols="30" cssClass="textboxes" id="companyDetails" />
                        </td>
                    </tr>
                    <tr>
                        <td>
