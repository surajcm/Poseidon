...
create table member (
    id          bigint generated by default as identity (start with 16) primary key,
    name        varchar(225),
    email       varchar(225),
...
create table make (
   id          bigint generated by default as identity (start with 12) primary key,
...
create table model (
    id              bigint generated by default as identity (start with 15) primary key,
